...
export const BUDDHIST_TEACHINGS: Teaching[] = [
    // ─── IMPERMANENCE (Vô Thường) — For Sadness/Loss ────────
    {
        ...
        text_vi: 'Đám mây không bao giờ chết. Nó chỉ trở thành mưa, thành tuyết, thành sông. Người thương của con cũng vậy — họ chỉ chuyển hóa.',
    ...
    },
    {
        ...
        topic: 'Vô thường',
        emotion_trigger: ['sad'],
        text_vi: 'Nhìn bông hoa, con thấy đám mây, mặt trời, mưa, đất. Bông hoa không tồn tại riêng lẻ.',
    ...
    },
    {
        ...
        topic: 'Vô thường',
        emotion_trigger: ['sad', 'lonely'],
        text_vi: 'Khi con nhìn vào mắt ai đó với sự chánh niệm, con sẽ thấy tổ tiên, con cháu, và toàn bộ vũ trụ trong đó.',
    ...
    // ─── COMPASSION (Từ Bi) — For Anger/Frustration ──────────
    {
        ...
        text_vi: 'Khi con giận, hãy ôm cơn giận như người mẹ ôm đứa con đang khóc. Con không đánh con, con ôm con.',
    ...
    },
    {
        ...
        text_vi: 'Hiểu được nỗi khổ của người khác là món quà lớn nhất con có thể tặng cho họ. Hiểu tức là yêu thương.',
    ...
    },
    {
        ...
        text_vi: 'Bước chân con trên mặt đất này chính là thiền. Mỗi bước đi, con trở về với chính mình.',
    ...
    },
    {
        ...
        text_vi: 'Con không cần đi đâu xa để tìm bình an. Bình an nằm ngay trong hơi thở này.',
    ...
    // ─── INTERBEING (Tương Tức) — For Loneliness ──────────────
    {
        ...
        text_vi: 'Con không cô đơn. Trong con có mẹ, có cha, có tổ tiên, có mặt trời, có mưa. Con là tất cả.',
    ...
    },
    {
        ...
        text_vi: 'Một chiếc lá có cả vũ trụ trong nó. Và con, con cũng vậy.',
    ...
    // ─── MINDFULNESS PRACTICE — For Seeking/Confused ──────────
    {
        ...
        text_vi: 'Chánh niệm là khi con rửa bát, con biết con đang rửa bát. Đó là tất cả.',
